...
#save the model
model.save_pretrained(f"outputs/gemma_4/lora_{datetime_string}/adapter_weights")
tokenizer.save_pretrained(f"outputs/gemma_4/lora_{datetime_string}/tokenizer_weights")
...
model.save_pretrained_merged(f"outputs/gemma_4/lora_{datetime_string}/fused_model_weights", tokenizer)

#saving to GGUF/llama.cpp conversion
#model.save_pretrained_gguf(f"outputs/gemma_4/lora_{datetime_string}/fused_model_weights", tokenizer, quantization_method = "Q8_0") # Q8_0, BF16, F16 supported